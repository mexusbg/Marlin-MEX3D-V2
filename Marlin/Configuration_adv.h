 ...
 */
#define USE_CONTROLLER_FAN // MEXUS
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PB15           // Set a custom pin for the controller fan // MEXUS
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings // MEXUS
 ...
 */
#define E0_AUTO_FAN_PIN PC7 // MEXUS
...
#define HOMING_BUMP_MM      { 4, 4, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump // MEXUS was { 5, 5, 2 
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING // MEXUS
...
#define SET_PROGRESS_MANUALLY // MEXUS
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  //#define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction
  #define M73_REPORT                    // Report M73 values to host // MEXUS
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define BACKUP_POWER_SUPPLY       // Backup power / UPS to move the steppers on power loss // MEXUS
    #define POWER_LOSS_ZRAISE       2 // (mm) Z axis raise on resume (on power loss with UPS) // MEXUS
    //#define POWER_LOSS_PIN         44 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
    #define POWER_LOSS_STATE     HIGH // State of pin indicating power loss // MEXUS
    #define POWER_LOSS_PULLUP         // Set pullup / pulldown as appropriate for your sensor // MEXUS
    //#define POWER_LOSS_PULLDOWN
    #define POWER_LOSS_PURGE_LEN   20 // (mm) Length of filament to purge on resume // MEXUS
    #define POWER_LOSS_RETRACT_LEN 10 // (mm) Length of filament to retract on fail. Requires backup power. // MEXUS
   ...
   */
  #define SDCARD_SORT_ALPHA // MEXUS
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting. // MEXUS
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option. // MEXUS
  ...
  #define UTF_FILENAME_SUPPORT // MEXUS

  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // MEXUS
  #define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol // MEXUS
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu // MEXUS
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' // MEXUS
  ...
  #define BINARY_FILE_TRANSFER // MEXUS

  #if ENABLED(BINARY_FILE_TRANSFER)
    // Include extra facilities (e.g., 'M20 F') supporting firmware upload via BINARY_FILE_TRANSFER
    #define CUSTOM_FIRMWARE_UPLOAD // MEXUS
  #endif
   ...
   */
  #define SDCARD_CONNECTION ONBOARD // MEXUS

  // Enable if SD detect is rendered useless (e.g., by using an SD extender)
  #define NO_SD_DETECT // MEXUS
 ...
 */
#define BABYSTEPPING // MEXUS
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING // MEXUS
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). // MEXUS
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. // MEXUS
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 // MEXUS
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.0        // (mm) Compression length applying to all extruders // MEXUS was 0.22
  #endif
...
#define SERIAL_FLOAT_PRECISION 4 // MEXUS
 ...
 */
#define ADVANCED_PAUSE_FEATURE // MEXUS
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      400  // (mm) The length of filament for a complete unload. // MEXUS was 100
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // (mm) Load length of filament, from extruder gear to nozzle. // MEXUS was 0
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. // MEXUS
  #define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change // MEXUS

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. // MEXUS
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current. // MEXUS was 800
    #define X_CURRENT_HOME  X_CURRENT / 2  // (mA) RMS current for sensorless homing // MEXUS was X_CURRENT
    ...
    #define Z_CURRENT       580 // MEXUS was 800
    #define Z_CURRENT_HOME  Z_CURRENT / 2 // MEXUS was Z_CURRENT
    ...
    #define E0_CURRENT      650 // MEXUS WAS 800
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // MEXUS
  ...
  #define Z_HYBRID_THRESHOLD      20 // MEXUS was 3
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  72 // MEXUS was 8
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70 // MEUXS was 8
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  10 // MEXUS was 8
    ...
    #define IMPROVE_HOMING_RELIABILITY // MEXUS
  #endif
 ...
 */
#define AUTO_REPORT_POSITION // MEXUS
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT // MEXUS
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations // MEXUS
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) // MEXUS
 ...
 */
#define HOST_ACTION_COMMANDS // MEXUS
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76 // MEXUS
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback // MEXUS
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications // MEXUS
  #endif
