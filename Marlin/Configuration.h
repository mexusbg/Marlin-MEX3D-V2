...
#define STRING_CONFIG_H_AUTHOR "(MEXUS, MEX3D V2)" // Who made the changes. // MEXUS
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0 // MEXUS
#endif
...
#define CUSTOM_MACHINE_NAME "MEX3D V2" // MEXUS
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // MEXUS
#define Y_DRIVER_TYPE  TMC2209 // MEXUS
#define Z_DRIVER_TYPE  TMC2209 // MEXUS
...
#define E0_DRIVER_TYPE TMC2209 // MEXUS
 ...
 */
#define PSU_CONTROL // MEXUS
#define PSU_NAME "Power Supply" // MEXUS

#if ENABLED(PSU_CONTROL)
  //#define MKS_PWC                 // Using the MKS PWC add-on
  //#define PS_OFF_CONFIRM          // Confirm dialog when power off
  //#define PS_OFF_SOUND            // Beep 1s when power off
  #define PSU_ACTIVE_STATE LOW      // Set 'LOW' for ATX, 'HIGH' for X-Box // MEXUS
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin // MEXUS
...
#define BANG_MAX 90      // Limits current to nozzle while in bang-bang mode; 255=full current // MEXUS FIX THIS
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.79 // MEXUS
    #define DEFAULT_Ki   1.68 // MEXUS
    #define DEFAULT_Kd  91.40 // MEXUS
  #endif
#endif
...
#define EXTRUDE_MAXLENGTH 600 // MEXUS
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. // MEXUS
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. // MEXUS
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 398.27, 94.5 } // MEXUS
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } // MEXUS
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 100, 10000 } // MEXUS
 ...
 */
#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration for printing moves // MEXUS
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts // MEXUS
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration for travel (non printing) moves // MEXUS
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 20.0 // MEXUS was 10.0
  #define DEFAULT_YJERK 20.0 // MEXUS was 10.0
  #define DEFAULT_ZJERK  0.4 // MEXUS was 0.3
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // MEXUS

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // MEXUS
 ...
 */
#define Z_MIN_PROBE_PIN PC14 // Pin 32 is the RAMPS default // MEXUS
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -58.565, -11, 0 } // MEXUS CHANGE ME
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // MEXUS
...
#define INVERT_Y_DIR false // MEXUS
#define INVERT_Z_DIR true // MEXUS
...
#define INVERT_E0_DIR false // MEXUS
...
#define X_BED_SIZE 220 // MEXUS FIX THIS
#define Y_BED_SIZE 220 // MEXUS FIX THIS

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 260// MEXUS was X_BED_SIZE
#define Y_MAX_POS 236 // MEXUS was Y_BED_SIZE
#define Z_MAX_POS 300 // MEXUS FIX THIS
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define AUTO_BED_LEVELING_UBL // MEXUS
 ...
 */
// #define RESTORE_LEVELING_AFTER_G28 // MEXUS
#define ENABLE_LEVELING_AFTER_G28 // MEXUS
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 0.0 // (mm) Default fade height. // MEXUS FIX THIS
  #endif
   ...
   */
  #define G26_MESH_VALIDATION // MEXUS
  ...
  #define GRID_MAX_POINTS_X 5 // MEXUS
...
#define MANUAL_X_HOME_POS -23 // MEXUS - bed offsets
#define MANUAL_Y_HOME_POS -13 // MEXUS - bed offsets
...
#define HOMING_FEEDRATE_MM_M { (20*100), (20*100), (4*100) } // MEXUS was HOMING_FEEDRATE_MM_M
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 // MEXUS
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. // MEXUS
 ...
 */
#define NOZZLE_PARK_FEATURE // MEXUS
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 20 // MEXUS
#define LCD_FEEDBACK_FREQUENCY_HZ 1000 // MEXUS
...
//
#define CR10_STOCKDISPLAY // MEXUS
...
#define NEOPIXEL_LED // MEXUS
  ...
  #define NEOPIXEL_STARTUP_TEST         // Cycle through colors at startup // MEXUS
